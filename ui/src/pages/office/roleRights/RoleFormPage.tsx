...
import DutyHoursRightsSection from "./rightsSections/DutyHoursRightsSection";
...
export default function RoleFormPage(props: Props) {
    ...
    const removeChildRights = (rights: List<string>, rightKey: string) => {
        switch (rightKey) {
            ...
            case Rights.DUTY_HOURS:
                return rights.filter(
                    (right) => !DutyHoursRights.some((x) => x === right)
                );
            default:
                                ...
                                <div style={{ marginLeft: 50 }}>
                                    ...
                                    >
                                        ...
                                        <FormControlLabel
                                            ...
                                            label={t(
                                                `rights.${Rights.ADMINISTRATION_IMPORT}`
                                            )}
                                        />
                                    </FormGroup>
                                </div>
