...
export default function UserFormPage(props: Props) {
    ...
    const onChangeChipId = (e: React.ChangeEvent<HTMLInputElement>) => {
        const newUser = { ...user, chipId: e.target.value } as User;
        setUser(newUser);
    };
                ...
                <>
                    ...
                    <div className={classes.slideInBody}>
                        <FormSection>
                            ...
                            <FormInput label={t("common.chipId")}>
                                <TextField
                                    InputProps={{
                                        classes: {
                                            input: classes.input,
