...
namespace API
{
    public class Startup
    {
        ...
        private void RegisterModules(IServiceCollection services)
        {
            ...
            services.AddScoped<DutyHoursEnricher>();

            services.AddScoped<IDutyHoursDao, DutyHoursDao>();
            services.AddScoped<IDutyHoursService, DutyHoursService>();

            services.AddScoped<IDutyHoursBookingDao, DutyHoursBookingDao>();
            services.AddScoped<IDutyHoursBookingService, DutyHoursBookingService>();
            
            services.AddScoped<IDrkServerImportService, DrkServerImportService>();
            services.AddScoped<ServerConnector>();
            
            services.AddScoped<IServiceLogTypeDao, ServiceLogTypeDao>();
            services.AddScoped<IServiceLogTypeService, ServiceLogTypeService>();
            
            services.AddScoped<IServiceLogDescriptionDao, ServiceLogDescriptionDao>();
            services.AddScoped<IServiceLogDescriptionService, ServiceLogDescriptionService>();
        }
    }
}