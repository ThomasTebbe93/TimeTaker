...
namespace API.BLL.UseCases.RolesAndRights.Services
{
    public interface IRoleService
    {
        ...
        Role FindByIdentWithRights( RoleIdent ident);
    }
    ...
    public class RoleService : IRoleService
    {
        ...
        public Role FindByIdentWithRights(RoleIdent ident)
        {
            var role = roleDao.FindByIdent(ident);
            var rightIdents = roleRightDao.FindByRoleIdent(ident)
                .Select(x => x.RightIdent)
                .ToHashSet();
            var rights = rightDao.FindByIdents(rightIdents);
