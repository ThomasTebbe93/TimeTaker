...
{
    [Table("servicelogdescription")]
    public class DbServiceLogDescription
    {
    ...
    public class DbServiceLogDescriptionCrudMap : ClassMapper<DbServiceLogDescription>
    {
        public DbServiceLogDescriptionCrudMap()
        {
            Table("servicelogdescription");
    ...
    public class DbServiceLogDescriptionQueryMap : EntityMap<DbServiceLogDescription>
    {
        public DbServiceLogDescriptionQueryMap()
        {
